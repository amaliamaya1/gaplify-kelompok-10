...
<div class="min-h-screen flex items-center justify-center p-4" style="background:#F8FAFC;">
    <div class="bg-white rounded-3xl shadow-sm p-8 sm:p-12 w-full max-w-md border border-[#E2E8F0]">
        ...
        @if (session('success'))
            <div class="mb-5 bg-green-50 text-[#22C55E] border border-green-200 p-3 rounded-xl text-[14px] flex items-center space-x-2">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePass('password','eye-login')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-[#64748B] hover:text-[#2563EB] transition-colors">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <a href="#" class="text-[14px] font-semibold text-[#2563EB] hover:text-blue-700 transition-colors">Lupa kata sandi?</a>
            </div>
        ...
        <div class="mt-8 text-center">
            <p class="text-[14px] text-[#64748B]">
                Belum punya akun? <a href="{{ route('register') }}" class="font-bold text-[#0F172A] hover:text-[#2563EB] transition-colors">Daftar</a>
            </p>
        </div>
    </div>
</div>
