            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role === 'student')
                        <x-nav-link :href="route('student.test.index')" :active="request()->routeIs('student.test.*')">
                            Tes Diagnostik
                        </x-nav-link>
                        <x-nav-link :href="route('student.recommendations.index')" :active="request()->routeIs('student.recommendations.*')">
                            Rekomendasi Materi
                        </x-nav-link>
